...
fs.copyFileSync(path.join(flatpakDir, 'com.jellodog.chat.desktop'), path.join(sourceDir, 'metadata', 'com.jellodog.chat.desktop'));
fs.copyFileSync(path.join(flatpakDir, 'com.jellodog.chat.metainfo.xml'), path.join(sourceDir, 'metadata', 'com.jellodog.chat.metainfo.xml'));
fs.copyFileSync(path.join(flatpakDir, 'jellochat-flatpak'), path.join(sourceDir, 'metadata', 'jellochat-flatpak'));
fs.copyFileSync(path.join(root, 'assets', 'app-icon-256.png'), path.join(sourceDir, 'icons', 'hicolor', '256x256', 'apps', 'com.jellodog.chat.png'));
