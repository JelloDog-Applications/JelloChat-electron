...
## 2. Eligibility
You must meet the minimum legal age in your jurisdiction to use JelloChat.
...
- Attempt unauthorized access, exploit vulnerabilities, or disrupt service operation.
- Spam, scam, or distribute malware.

## 5. Community and Moderation
Server owners and moderators may manage community spaces (for example invites, kick, ban, unban, and channel controls) according to platform rules and applicable law.

We may remove content, limit accounts, or terminate access when rules are violated or when necessary for safety and legal compliance.

## 6. User Content
You retain ownership of content you submit, but you grant us a limited license to host, store, process, and display it as needed to operate JelloChat.

You are responsible for ensuring you have rights to content you post.

## 7. Privacy
Use of JelloChat is also governed by the Privacy Policy in `PRIVACY_POLICY.md`.

## 8. Third-Party Services
JelloChat may rely on third-party infrastructure (for example email and voice services). Availability and performance may depend on those services.
...
To the fullest extent allowed by law, JelloChat and its operators are not liable for indirect, incidental, special, consequential, or punitive damages, or loss of data, profits, or goodwill arising from use of the service.
